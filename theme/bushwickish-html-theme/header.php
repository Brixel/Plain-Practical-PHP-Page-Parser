...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo $base_url ?>/css/melody.css">
	    ...
	    <meta property="og:image" content="<?php echo $base_url ?>/img/og_image.gif">
	    <meta property="og:site_name" content="Brixel Hackerspace Hasselt">
	    <meta property="og:description" content="%TODO%">

		<style>
			.sidebar {
				background: url("<?php echo $base_url ?>/img/ohm-sidebar-bg.jpg") center no-repeat;
